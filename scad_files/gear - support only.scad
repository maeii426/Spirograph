...
union() {
    union() {
        difference(){
            union () {
                union () {
                    translate([0, 0, support_height/2]) color([1.00,0.5,0.5]) cylinder (h = support_height, r=support_radius, center = true, $fn=20);
                    translate([0, 0, pin_height/2-thickness/2-1.5]) color([1.00,0.5,0.5]) cylinder (h = thickness/2, r=support_radius*2, center = true, $fn=20);
                }
                translate([0, 0, 0]) color([1.00,0.5,0.5]) cylinder (h = support_height*1.3, r=hole/2, center = true, $fn=20);
            }
            translate([0,0,-9]) cylinder(6,20,20,true);
        }
        translate([0, 0, support_height]) color([1.00,0.5,0.5]) cylinder (h = support_height*2, r=1.9, center = true, $fn=20);
    }
//    translate([0, 0, pin_height/2+thickness/2+1.5]) color([1.00,0.5,0.5]) cylinder (h = thickness/2, r=support_radius*2, center = true, $fn=20);
}
